public class PassengerQueue {
    ...
    //set the first index of the circular array
    public void setFirst(int first) {
        this.first = first;
    }

    //set the last index of the circular array
    public void setLast(int last) {
        this.last = last;
    }

    //set the average time in queue
    public void setAvg_timeInQueue(int avg_timeInQueue) {
        this.avg_timeInQueue = avg_timeInQueue;
    }

    //get the average time in the queue.
